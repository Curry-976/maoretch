        ...
        <div className="relative z-10 space-y-10 max-w-[600px]">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              >
                <f.icon className="w-3 h-3 text-primary" strokeWidth={2} />
                {f.label}
              </div>
            ))}
          </div>
          ...
          <div className="w-full max-w-[380px] space-y-10">
            ...
            <form onSubmit={handleSendOTP} className="space-y-5">
              ...
              <button
                ...
                className="btn-magnetic group w-full flex items-center justify-center gap-2 px-5 py-3.5 ink-surface rounded-md text-[14px] font-medium hover:bg-primary disabled:opacity-40 disabled:cursor-not-allowed shadow-lg shadow-ink/20 hover:shadow-primary/30"
              >
                {loading ? (
                  <>
